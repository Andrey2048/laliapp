...
import ru.netology.laliapp.databinding.FragmentSignUpBinding
import ru.netology.laliapp.utils.AndroidUtils.hideKeyboard
import ru.netology.laliapp.viewmodel.SignUpViewModel
...
class SignUpFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.photo.observe(viewLifecycleOwner) {
            ...
            binding.imageViewAvatar.setImageURI(it.uri)
        }
