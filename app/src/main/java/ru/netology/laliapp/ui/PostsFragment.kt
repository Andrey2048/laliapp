...
import ru.netology.laliapp.adapter.LoadingStateAdapter
...
class PostsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = PostsAdapter(object : OnPostInteractionListener {
            ...
            override fun onMentionPost(post: Post) {
                if (post.ownedByMe) {
                    ...
                    Toast.makeText(activity, R.string.error_no_permission, Toast.LENGTH_SHORT)
                        .show()
                }
            }
        ...
        binding.fabAddPost.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_nav_feed_to_nav_new_post_fragment)
        }
